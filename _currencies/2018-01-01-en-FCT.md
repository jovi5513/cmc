	                ...
	                <div class="col-md-6 col-xs-12">
	                  <div class="panel">
	                    <div class="panel-header bg-primary">
	                      ...
	                      <div class="panel-content">
	                       Entreprise and Policy are the things make the most concern of man. Factoids or Factom is a special blockchain to businesses and governments. The users can use Factom to simplify records management, record business processes, etc with remarkable applications, including audit systems, medical records, supply chain management, voting systems, property titles, legal applications, and financial systems.
	                      </div>
	                  </div>
	                </div>
	                ...
	                <div class="col-md-6 col-xs-12">
	                  <div class="panel">
	                    <div class="panel-header bg-primary">
	                      ...
	                      <div class="panel-content">
	                       FCT was considered as fully approachable for any usersby their techical features. Firstly, everone can find the software tokens on Poloniex and its benefits from this platform. Secondly, the investors have been eagerly awaiting by Factoids trading on crypto-exchanges and it allows new members to purchase some tokens for future use.
	                      </div>
	                  </div>
	                </div>
	                <div class="col-md-6 col-xs-12">
	                  <div class="panel">
	                    <div class="panel-header bg-primary">
	                      ...
	                      <div class="panel-content">
	                       Factom put on one blockchain three technologies are a private Factom chain and two public chains, Bitcoin and Ethereum. The Harmony application provides a single permanent document catalogue that is helpful for audits, file reviews, lost documents, post-closing and litigation.
	                      </div>
	                  </div>
	                </div>
